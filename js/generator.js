...
function generateHeader(text, home, help) {
	...
	if(localStorage.lang=="ENG"){
		...
		if(help) 
		document.write("<div class='help'><a href='../help/" + text + ".html" + "'rel=\"external\"><img class='head-bt' id='help-bt' src='../images/ayuda(help)-button.png'/></a></div>");
		if(home) 
		document.write("<div class='home'><a href='../home/home_esp.html' rel=\"external\"><img class='head-bt' id = 'home-bt' src='../images/casa(home)-button.png'/></a></div>");
	}
