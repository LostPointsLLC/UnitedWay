...
growth_6months.push("Remember that a warm, responsive and dependable adult caregiver is the most essential ingredient to her healthy development.");
growth_6months.push("Sleep – At this stage, your baby still needs two or possibly three naps a day – a morning, afternoon, and late day nap. Put your baby down to sleep for the night between 7 and 8 pm, and expect her to sleep 11 to 13 hours. However, even as late as eight or nine months, she may still wake for a night feeding – especially if she’s being breastfed.");
growth_6months.push("Let your doctor know if your baby at 6 months: Seems very stiff, with tight muscles. Seems very floppy, like a rag doll. Refuses to cuddle. Doesn’t seem to enjoy being around people. Cannot sit with help. Does not laugh or squeal. Does not actively reach for objects.  At 9 months: Drags one side of body while crawling (for over a month). Does not point to objects or pictures. Does not search for objects that are hidden while he watches.");
growth_6months.push("Physically – at 6-9 months your baby will probably: Sit alone without support. Reach for a cup or spoon when being fed. Transfer objects from one hand to the other.  At 9-12 months your baby will probably: Crawl well. Pull herself to a standing position.");
growth_6months.push("Intellectually – At 6-9 months your baby will probably: Make noises to show displeasure or satisfaction. Look for a ball rolled out of sight. At 9-12 months your baby will probably: Play Pat-a-Cake. Dance or Bounce to music. Say her first word. Clap hands, wave goodbye.");
growth_6months.push("Socially and Emotionally – at 6-9 months your baby will probably: Try to talk to image of self in mirror. Become distressed if a toy is taken away. Respond to own name and recognize family members names. Show mild to severe anxiety at separation from parent. At 9-12 months your baby will probably: Offer toys or objects t others but want them to be returned. Push away toys or food when she doesn’t want them. Become attached to a favorite toy or blanket.");
growth_6months.push("Attachment – Your child will show her strong attachment to her primary caregiver by acting upset when she leaves and happy when she returns. To ease the anxiety caused by separating: Say goodbye, so she learns that you will come back. Explain that you are going to leave, but that you’ll return. Provide a comfort object that will make her fell close to you.");
...
safety_6months.push("As your baby begins to crawl, he will want to touch everything he can – this is how he learns about his world. Therefore, make his environment safe. Install safety latches on cabinets, drawers, and toilets. Cover unused electrical outlets with outlet covers and use cleats to secure dangling cords on drapes and blinds. Gate staircases and steps, cover sharp edges of furniture and ledges on fireplaces. Keep older children’s toys out of your baby’s reach. These may have small parts that can be a choking hazard for your little one. Keep all detergents, medicines, sharp objects out of your child’s reach. Contact Poison Control immediately if you think your child has eaten or drunk something poisonous: 1-800-222-1222.");
safety_6months.push(" Keep in mind…Always be aware of your baby’s safety. Never leave her unattended near water, open windows, fireplaces or any electrical appliances. Watch her carefully when she is in the kitchen or bathroom where potential dangers are everywhere.");
...
growth_12months.push("Sleep – At this time, most children start giving up their morning nap and instead take one longer afternoon nap per day. As your child begins to lose the second nap, you may notice he is ready for bed a little earlier while he adjusts to the change.");
growth_12months.push("At 12 months, let your doctor know if your baby: Does not crawl. Drags one side of body while crawling for over one month. Cannot stand while supported. Doesn’t search for objects that are hidden while he watches. Says no single words. Does not point to objects or pictures. Does not use gestures such as waving or shaking head.");
growth_12months.push("Discipline – Your child’s growing sense of independence will push her to test her behavior with you. This is the right time to set a few limits. Your child’s first rules should help protect her safety and be enforced clearly and consistently. Stay one step ahead. Distract or redirect your child from unsafe objects or activities. Save “no” primarily for safety issues. If your child hears “no” to often, she will start to tune it out. Use non-verbal communication. Give a stern or firm look for minor incidents.");

var safety_12months = new Array();
safety_12months.push("As your child becomes increasingly mobile and curious, you must make”child-proofing” you home a priority.");
...
playtime_12months.push("Literacy – Make reading interactive by asking questions while looking at pictures and reading stories. Even though your child cannot yet answer fully, pay attention to his verbal and non-verbal responses. Provide your child with books that can easily be carried by little hands and which offer flaps and textures he can explore. Teach new songs and incorporate hand movements such as “Pat-a Cake” and “Itsy-Bitsy Spider”.");
playtime_12months.push("Play- Your child’s desire and ability to do things on her own will extend to her play. So, allow your child to use toys in any way she wants. When your child is able to explore freely, she learns to imagine, invent and problem solve. Plan play dates. Consider your child’s nap time so she won’t be too tired to spend time with her new friend. Remember, children at this age are too young to be expected to share. Allow time for your child to play alone. Independent play allows him to choose and direct the activity, and helps build confidence. Try new ways to play games like peek-a-boo and introduce new toys she can push and pull, or items she can stack such as boxes or cups.");
...
health_12months.push("By 12 months your baby is ready to stop drinking formula and begin drinking up to 24 ounces of whole milk a day. He should be drinking from a cup rather than a bottle. Don’t forget to offer water throughout the day.");
...
growth_18months.push("At 18 months let your doctor know if your child: Cannot walk. Fails to develop a mature heel-toe walking pattern after several months of walking, or walks exclusively on his toes. Does not speak at least 15 words. Does not seem to know the function of common household objects (brush, telephone, fork, spoon).");
growth_18months.push("Sleep – They often take one nap a day usually from about 1 to 3 pm, and go to bed between 6 and 8 pm. It is still important for her to sleep during the day. If she is well rested, she can fall asleep easier and sleep longer during the night.");
growth_18months.push("By the time your child reaches 24 months, he will probably do most of the following: Refer to self by name and use the words “me” and “mine”. Copy single words spoken by someone else and use the words “please” and “thank you” if prompted. Choose between two objects. Enjoy humming or trying to sing familiar songs. Use two to three word sentences. Walk well and run, even though he may not always stop and turn well. Toss or roll balls. Enjoy moving on small-wheeled riding toys. Feed himself with a spoon. Get angry and even may have some temper tantrums. Act shy around strangers. Have trouble sharing.");
...
growth_18months.push("Discipline – Praise good behavior – reach through positive reinforcement. Ignore small incidents and accidents, such as spilled milk. Give your child the opportunity to correct misbehavior by giving her a second chance. Model good behavior.");
...
growth_18months.push("Attachment – Your toddler is, at the same time, excited about his new-found independence, but hesitant to stray too far from you. Chances are, he struggles with goodbyes and returns often to your side.  Say goodbye when you leave. At first he might cry, but soon he’ll learn that you always come back. If you leave without saying goodbye, he may begin to fear that you may slip out at any time, and so he may cling to you even more.  See that your child is involved in an activity when you’re ready to leave. If he’s busy, he will have an easier time getting over your departure and getting re-involved after you leave.");
...
playtime_18months.push("This is a wonderful time to help your child’s rapidly growing vocabulary by talking to him about everything, and reading together every day.");
playtime_18months.push("Plays with toys for longer periods of time, and enjoys doing things for herself. Play simple recognition games. Place three familiar objects in front of your child and say, “please give me the…”. Encourage your child to play by himself, but be available to help out if an activity seems too difficult.  Arrange play dates. They can be rocky but it is good for toddlers to learn about interaction with other children. Remember, toddlers are just learning how to play with someone else and should not always be expected to share.");
...
health_18months.push("Nutrition – By 18 months, toddlers should eat most table food cut up into small pieces, drink from a sippy cup and be fully weaned from a bottle. Because toddlers may not be interested in sitting still for meals, you can make sure your toddler gets enough food by: Giving him five to six small meals per day. Offering finger foods so she can feed herself. Making meals fun by serving foods with a variety of colors, textures and tastes.");

//@24months to 36months
var growth_24months = new Array();
growth_24months.push("By the time your child reaches 36 months, she will probably have a vocabulary of around 900 words and use three to five word sentences. Your praise, encouragement and support as she works to perfect her motor skills and increase her knowledge of the world around her will help her grow up strong, happy and confident.");
growth_24months.push("Sleep – For many, it’s time to leave the crib and move on to a bed. Make the transition exciting by talking about the big bed and the items that might go in it such as anew bedding or favorite stuffed animals. Stick to the same bedtime and make sure your child understands that she can’t get out of bed once she’s been kissed good night and tucked in. If your child gets out of bed, you should quietly and calmly take her back to bed until she learns to stay there. It might be necessary to return her to her crib and try making the transition in a month or so. Continue with your normal routines like reading, singing and bathing even after you’ve moved your child to a big bed.");
growth_24months.push("Toilet Training – In general, your child is ready if he does any or some of the following: Pulls his pants up and down. Is interested in the toilet and imitates others’ bathroom habits. Can and will follow simple instructions. Dislikes the feeling of being in a dirty diaper. Understands the physical signs that indicate he has to “go” before “going”. Has long dry periods.");
growth_24months.push("Starting the process – Wait to begin until you are both ready. Be encouraging and patient. Accidents are natural-don’t punish your child.");
growth_24months.push("Physically – Throw and kick a ball. Zip and unzip. Help to put things away. Drink from a cup without spilling. Pull off and begin to put on her own clothes. Jump in place and walk on tiptoes.");
growth_24months.push("Intellectually – Call herself by her own name. Have a vocabulary of 900 or more words. Point and name her own body parts when asked. Use phrases and three to five word sentences.");
growth_24months.push("Socially and Emotionally – Initiate her own play activities. Want routines to always be the same. Observe other children at play and join in. have a hard time sharing things.");
growth_24months.push("The Terrible Twos – Between two and three, your child is beginning to realize that he is a person independent form you. He will want to exercise his free will, largely by opposing much of what you want or expect from him. His protests will probably include temper tantrums and heavy use of the word “no”. Tips for taming tantrums – Try to keep your cool. He will lose control even more if you really lose your temper. Rather than using physical punishment, create consequences that relate to the behavior. For example, remove a child from the store if he misbehaves. Stay in control by not giving in to unreasonable demands. Discuss the issue. When your child is calm, validate his feelings while letting him know that his behavior is not acceptable. Avoid problem-causing situations, If you know your child throws a fit when he’s hungry, remember to carry snacks with you.");
growth_24months.push("Remember…Although a temper tantrum is a natural and healthy expression of your child’s emotions and frustrations, he must be taught that it is not an acceptable behavior.");

var safety_24months = new Array();
safety_24months.push("Make sure that the area around your child’s bed is safe, in case she falls or gets out of her bed by herself at night.");
safety_24months.push("Two-year-olds sill must ride in the backseat of a car in a car seat with a harness-preferably in the  middle of the backseat.");
...
playtime_24months.push("Helping her create imaginative games and new ways to use toys. Blocks can be flying cars or even zoo animals. Giving her time to play by herself. Playing alone gives her a chance to process and understand what she has been doing and learning all day.");
playtime_24months.push("Expand your child’s language by reading together every day and by: Asking questions about the book you’re reading to include her in the story and to make sure she understands. Offering materials to scribble, draw or pretend to write. Encouraging her to identify letters and their sounds. Pointing to words when you read. This will help your child understand how the reading process works.");

var health_24months = new Array();
health_24months.push("Most doctors have you bring your child in for a two-year check-up. By age two, your child has received most of her immunizations, including: Hep B, Hib, Polio, DTap or DTP. MMR and Chickenpox.");
health_24months.push("At 24 months let your doctor know if your child: Cannot push a wheeled toy. Does not follow simple directions. Does not imitate actions or words. Cannot walk (by 18 months). Fails to develop a hell-toe walking pattern after several months of walking or walks exclusively on toes. Does not speak at least 15 words by 18 months. Does not use two word sentences.");
health_24months.push("Nutrition – At this age, children often become picky eaters and lose interest in food. You may find that some days, your child might not be interested in food at all, and oter days he might only want to eat a certain type of food. Be assured when your child is hungry, he will want to eat – it is your job to ensure you are providing healthy options by offering a variety of nutrient-rich foods.");
...
growth_3years.push("Preschool – First, your child’s preschool may require her to be trained in order to attend. So, set her up for success: Let her use toilets outside of your home. Dress her in Clothes  that are easy for her to pull up and down. Have boys practice from a standing position.");
growth_3years.push("Staying dry at night – Using the potty right before bed. Limiting liquids after 5pm. Putting her to bed in underwear instead of pull-ups. Making the potty accessible to her in the night.");
growth_3years.push("Physically -Throw and kick a ball. Draw circles and squares. Begin to coy capital letters. Dress and undress.");
growth_3years.push("Intellectually - Indentify “same” and “different” objects. Talk in short sentences so that others can understand. Tell and remember parts of stories.");
growth_3years.push("Socially and Emotionally – Cooperate with other children. Engage in fantasy play. Understand that there are ways to solve problems.");
growth_3years.push("Whether at school or at a playgroup, you’ll notice that your child is beginning to make friends. For the first time, he faces difficult new issues like sharing and taking turns. Show him how to share – Also, let him see you sharing with others. Use the word “share” during these interactions, so he can begin to connect the word to the action. Also before guests arrive, put away toys that your child does not want to share. Practice with your child, play games that involve taking turns such as board games, the memory game and hide-and-seek are good. Praise your child when he shares.");
growth_3years.push("Limit media watching(including TV, computer, video games, etc). One to two hours per day is more than enough. Also, monitor the shows he watches. Tune into shows that have nice messages. Tune out the violence.");

var safety_3years = new Array();
safety_3years.push("In the car – Booster time? If your child has reached the top weight or height allowed for her car seat, her shoulders are above the top harness slots, or her ears have reached the top of the seat, she is ready for a booster seat. Always use a lap/shoulder belt with a booster seat. Stick with the booster until the adult seat belt fits properly, usually between 8 and 12 years old and about 4’9” tall.");
safety_3years.push("Remind her to wash her hands well when she comes in from outside, after using the toilet and before she eats.");

var playtime_3years = new Array();
playtime_3years.push("Read everyday. Ask questions about stories and pictures.");

var health_3years = new Array();
health_3years.push("The Dentist – By the time your child turns three, she should have almost all of her 20 baby teeth. This means it’s time to visit the dentist if you haven’t already. Prepare your child by talking about what will happen at the dentist’s office and reading books about going to the dentist. The dentist will count and examine your child’s teeth, and give a lesson about how to brush her teeth. Brush teeth at least once per day (especially at night). Use a child-size toothbrush with a pea-sized bit of fluoride toothpaste. Let your child brush her teeth herself and then help her to make sure her teeth get cleaned. Is brushing a battle? Give her your toothebrush so that she can “clean” your teeth while you clean hers.");
health_3years.push("Nutrition – Choking is still a hazard because your child has not yet mastered chewing and swallowing. So, make portion sizes small, especially when serving: Grapes (cut them in half). Hot dogs (slice in half across and lengthwise). Raw vegetables, such as carrots and celery. Peanut butter (avoid spoonfuls). Avoid entirely foods such as hard candies and cherries with pits.");

//@4years
var grwoth_4years = new Array();
growth_4years.push("Get ready for Kindergarten. It’s a big jump and with it comes growing pains. Your child will challenge himself to learn new things – like staying dry through the night or tying his shoes. As he does, he will face frustration. Your encouragement and support can ease aggravation and help him accomplish his goals.");
growth_4years.push("Sleep – Your child probably sleeps between 10 to 12 hours per night and no longer takes an afternoon nap. Bad/vivid dreams: If your child wakes in the night from a bad dream, comfort her until she is able to go back sleep. You also may want to talk to her about the dream. Night terrors: These are episodes in which a child may suddenly bolt upright in bed, cry, scream, moan, mumble, and thrash about with her eyes wide open, even though she is not truly awake. Do no wake your child. Rather, stay with her until the terror ends and she calms down. Bedwetting: reward your child for dry nights, but do not punish her for wet nights. Give her lots of support. Seek professional help if the problem persists.");
growth_4years.push("Let your doctor know if, by the time your child is five she exhibits any of the following: Very fearful, timid or extremely aggressive behavior. Unable to concentrate on one activity for more than five minutes. Little interest in playing with other children. General unhappiness or sadness much of the time. Trouble eating, sleeping or using the toilet. Can’t tell the difference between fantasy and reality.");
growth_4years.push("Intellectually – Tell her full name and address. Count to ten or more objects.");
growth_4years.push("Physically – Hop on one leg. Copy triangles and other geometric patterns");
growth_4years.push("Discipline – Handle discipline with the same set of rules: If you consistently tell your child “no” he will stop listening. Use positive wording instead. Say, “let’s jump off the pillows instead of the bed.” And only say “no” when necessary. Choices allow your child to feel in control of his world. But make the choices limited so they are not overwhelming. “Would you like to do a puzzle or read a book after dinner?” Make your expectations clear, Set up rules that are easy to understand and enforce them time and again. For example, tell your child that he can play outside after he cleans up his toys.");
...
growth_4years.push("Do not however, do the task for your child. This will prevent your child form learning how to cope with frustration as well as master the skill he is developing.");

var safety_4years = new Array();
safety_4years.push("In the car – Your child should ride in his booster seat until the adult seat belt fits properly, usually between 8 and 12 years old and about 4’9”tall.");
safety_4years.push("Around the house – Because your child is more independent at home, safety precautions must be taken to assure he doesn’t get hurt while on his own. Never leave your child unattended near water, even if he knows how to swim. Remove cleaning substances, medicines, vitamins, and toxic houseplants out of the child’s reach. Keep pots on back burners of the stove.");
safety_4years.push("Home Fire Drills – Plan and practice. In addition to a working fire extinguisher and smoke detectors, your family should have a plan for members to follow in the event of a fire.");
...
playtime_4years.push("Read everyday. Ask questions about stories and pictures.");

var health_4years = new Array();
health_4years.push("At your child’s yearly check-up, her doctor may test her hearing and vision.");
health_4years.push("Nutrition – Three meals per day, plus two small snacks. Small portions. Nutritious food. Explanations about why eating healthy is important for your body. Talk about how eating fruits, vegetables, low-fat meats and whole grains helps your body stay healthy. Chances for your child to plan meals and prepare foods. Take your child grocery shopping and let her pick out a new fruit to try. Cook healthy meals together – smoothies with fresh fruit, pizza with cheese, blueberry muffins. Visit an apple orchard or farm, to help your child understand about natural foods. Be a good example. If you choose healthy foods for yourself, your child will likely follow.");
...
growth_5years.push("Praise good behavior. Be respectful. Don’t yell. And, before you ask him to do something, make sure he knows how to do it. Pick your battles. Respect his needs to feel independent and explore. Also, where you can, avoid situations that trigger your child’s defiant streak.");
growth_5years.push("Stopping the Sass – Talking back is often a sign of anger, frustration, fear or disappointment. When you respond: Stay cool. Offer support. Make rules. Tell him that if he speaks nicely, you will listen.");
growth_5years.push("Uncovering the truth – A kindergartener may make up stories for lots of reasons. Before you confront your child, try to understand why he lied.");
growth_5years.push("Preparing for Kindergarten – the start of kindergarten is a time of excitement, anxiety and change for a child. To get your child off on the best foot, you should help him understand what to expect before classes begin. Talk about school. Take your child through his new routine. Drive or walk to school and back. Take a tour of the school. Show him his classroom. Be supportive. Appreciate that going to kindergarten is a big deal for your child. Listen to his concerns, answer questions and read books about starting school. Be patient if his transition is rough. Keep it calm at home. With all the adjustments to school, it is important that home remain a safe haven. Provide plenty of down time. Make yourself available to play with and talk to your child.");

var safety_5years = new Array();
safety_5years.push("Dealing with strangers – Tell your child that she should walk away and find an adult she knows if approached by anyone.");
safety_5years.push("On the playground – Sharp points, corners or edges, splintered wood or hot metal (such as slides). Openings that might trap a child’s hands or feet, and loose calbles, wires and ropes that may trip a child. Equipment that is not securely anchored to the ground, including handrails, ladders and steps.");
safety_5years.push("Take note..Simply telling your child to not talk to strangers is not good advice. Sometimes such as when you introduce her to a friend of yours, it’s okay to talk to a stranger. Or, if your child is lost, she should know to ask someone for help.");

var playtime_5years = new Array();
playtime_5years.push("Read. Tell and re-tell Stories. ABC and counting games. Draw, color, art.");

var health_5years = new Array();
health_5years.push("Check with your child’s doctor and school to ensure she has had the required vaccinations. Make sure eyes, teeth and Dr. appointments are scheduled prior to kindergarten.");
health_5years.push("Nutrition – Also make sure she knows about any food allergies or other dietary restrictions that she has.");
health_5years.push("Physically – Assist in making his bed. Color within lines. Tie his shoes. Jump rope independently.");
health_5years.push("Intellectually – Group similar objects together. Understand the idea of today, tomorrow, and yesterday. Identify most letters and numbers. Retell a story from a picture book with reasonable accuracy.");
health_5years.push("Socially and Emotionally – Comfort friends who are sad or hurt. Understand that there are rules when playing games. Express feelings.");
